...
assert.match(popup, /href="https:\/\/x\.com\/amzinvite"/);
...
assert.match(popup, /id="toggle-monitoring-status"/);
assert.match(popupJs, /monitoringStatusCollapsed/);
assert.match(popup, /\.prime-badge/);
assert.match(popupJs, /class="prime-badge"/);
assert.match(popupJs, /amazonPrimeByMarketplace/);
