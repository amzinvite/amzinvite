...
assert.equal(
  ...
  "https://prixtcg.fr/r/amzinvite/B0ABCDEF12?source=amzinvite",
);
assert.equal(
...
assert.equal(
  links.catalogueUrl(),
  "https://prixtcg.fr/pokemon/catalogue?source=amzinvite",
);

console.log("  ✓ liens PrixTCG : ASIN exact et provenance amzinvite");
