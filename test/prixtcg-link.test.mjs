...
assert.equal(
  ...
  "https://prixtcg.fr/r/amzinvite/B0ABCDEF12?resolver=2&source=amzinvite&utm_source=amzinvite&utm_medium=extension&utm_campaign=product",
);
assert.equal(
  links.productComparisonUrl("https://www.amazon.com.be/Pokemon/dp/b0abcdef12?th=1"),
  "https://prixtcg.fr/r/amzinvite/B0ABCDEF12?resolver=2&source=amzinvite&utm_source=amzinvite&utm_medium=extension&utm_campaign=product",
);
assert.equal(
